...
export default function SignupFormDemo() {
  ...
  return (
    <div className="max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-sm bg-white dark:bg-black">
      <h2 className="font-bold text-xl text-neutral-800 dark:text-neutral-200">
        Welcome to ChessBet
      </h2>
      <p className="text-neutral-600 text-sm max-w-sm mt-2 dark:text-neutral-300">
        Login to ChessBet if you can because we don&apos;t have a login flow yet
      </p>
      ...
      <form className="my-8" onSubmit={handleSubmit}>
        ...
        <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2 mb-4">
          ...
          <LabelInputContainer>
            ...
            <Input id="state" placeholder="NY" type="text" />
          </LabelInputContainer>
          <LabelInputContainer>
            <Label htmlFor="zipcode">Zip Code</Label>
            <Input id="zipcode" placeholder="10001" type="text" />
          </LabelInputContainer>
        </div>
