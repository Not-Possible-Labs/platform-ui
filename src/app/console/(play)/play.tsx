        ...
        <div className="flex flex-col gap-4 h-full">
          ...
          <div className="flex gap-4">
            ...
            <div className="flex w-1/2 flex-col gap-4">
              ...
              <div className="h-[248px] overflow-hidden rounded-lg border border-neutral-200 dark:border-neutral-700">
            ...
            <div className="w-1/2 flex flex-col">
              ...
              <div className="h-[248px] rounded-lg bg-neutral-100 dark:bg-neutral-800">
                <NewsTimeline />
              </div>
            </div>
          </div>
